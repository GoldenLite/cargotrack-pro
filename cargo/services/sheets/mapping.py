...
GEN_RELEASE_TYPE   = 'Выпуск'              # B2B / B2C / Документы
GEN_CLIENT_INN     = 'ТО Клиент'           # ИНН клиента (10 или 12 цифр)
GEN_PROBLEM        = 'Проблема'
GEN_CARGO_KIND     = 'Тип груза'
GEN_HAWB_NUMBER    = 'Накладная СДЭК'      # ключ матчинга
GEN_TSD            = 'ТСД'
GEN_ARRIVE_DATE    = 'Дата прибытия'
GEN_BOND_DATE      = 'Дата размещения'
GEN_WAREHOUSE_LIC  = 'Лицензия СВХ'

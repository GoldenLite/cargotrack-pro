...
FINALIZE_STEPS = [
    ...
    # Само-хил колонки «Регистрационный номер ДТ» (X) — аудит её НЕ покрывает
    # (fill-empty ручная колонка), а на выпуске запись могла промахнуться.
    # Окно 21 день (дёшево); полный бэкфилл — вручную heal_user_decl --all.
    ('heal_user_decl',   'heal_user_decl',      {}),
